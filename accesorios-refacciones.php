...
<div class="container">
    <div class="tittle">
        <h1 style="font-size: 54px">Tenemos la <span class="semi-highlight">refacción</span> y/o</h1>
        <h1 style="font-size: 54px"><span class="semi-highlight">Accesorio</span> que necesitas</h1>
    </div>
